  ...
  const openaiResponse = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "taskSummary.items, scheduleSummary.items, reportNotes 중 실제로 비어 있지 않은 당일 기록을 최소 하나 이상 반드시 근거로 사용하세요. 일반적인 칭찬 문구만 반복하지 마세요.",
        "칭찬은 실제 업무 문장·시간·작성자 중 하나를 짧게 언급한 구체적 실행 근거를 포함하고, 피드백은 비난 없이 그 기록과 연결되는 가장 중요한 보완점 하나만 제시하세요.",
        "칭찬·피드백·다음 행동에는 가능한 한 서로 다른 당일 근거를 사용하고, 업무가 기록되어 있는데도 '기록을 남겨주세요' 같은 일반 문구만 반복하지 마세요.",
        ...
        "evidence에는 위 코칭에 실제 사용한 당일 업무·일정·업무보고 근거를 1~3개, 짧은 원문 요약 형태로만 작성하세요. 제공되지 않은 사실은 만들지 마세요.",
