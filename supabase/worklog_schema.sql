create table if not exists public.profiles (
  ...
  worklog_status text not null default 'active',
  worklog_status_reason text not null default '',
  worklog_excluded_from date,
  worklog_excluded_until date,
  worklog_status_updated_by uuid references auth.users(id),
  worklog_status_updated_at timestamptz,
...
-- worklog managers may inspect the progress without opening employee PII.
